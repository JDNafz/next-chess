  ...
  return (
    ...
    >
      <g strokeWidth="2.684" transform="translate(-241.967 -290.398)">
        ...
        ></path>
        <path fill="none" stroke="#fff" d="M-228.96 224.014s-76.177 56.995-76.177 159.919"></path>
        <path fill="none" stroke="#20201e" d="M-132.25 328.275c-.063-.094-.063-.094 0 0z"></path>
        <path
          fill="none"
          stroke="#fff"
          d="M-213.262 263.56c-1.451 16.28 6.11 27.91 6.399 28.928 0 0-18.32-9.446-20.066-21.954"
        ></path>
        <path fill="none" stroke="#fff" d="M-206.875 292.473s-12.213 5.963-21.226 2.183"></path>
        <path fill="none" stroke="#20201e" d="M-131.84 328.905s-8.144-10.474-10.473-15.27"></path>
        <path
          fill="none"
          stroke="#fff"
        ...
        ></path>
        <path fill="none" stroke="#fff" d="M-244.376 238.423L-252.651 233.169"></path>
        <path fill="none" stroke="#fff" d="M-261.384 257.174L-269.671 253.241"></path>
        <path fill="none" stroke="#fff" d="M-276.646 278.913L-286.241 274.981"></path>
        <path fill="none" stroke="#fff" d="M-288.865 303.83L-298.889 300.338"></path>
        <path fill="none" stroke="#fff" d="M-298.455 333.058L-308.925 330.006"></path>
        <path fill="none" stroke="#fff" d="M-304.127 362.694L-315.028 361.404"></path>
      </g>
    </svg>
  );
}
