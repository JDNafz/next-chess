  ...
  return (
    ...
    >
      <g strokeWidth="2.684" transform="translate(-1225.682 -283.067)">
        ...
        ></path>
        <path fill="none" stroke="#fff" d="M777.914 216.684s76.176 56.991 76.176 159.922"></path>
        <path fill="none" stroke="#000" d="M681.203 320.945c.063-.094.032-.094 0 0z"></path>
        <path
          fill="none"
          stroke="#fff"
          d="M762.215 256.23c1.45 16.279-6.108 27.91-6.397 28.927 0 0 18.32-9.447 20.066-21.953"
        ></path>
        <path fill="none" stroke="#fff" d="M755.797 285.142s12.213 5.964 21.227 2.183"></path>
        <path fill="none" stroke="#000" d="M680.794 321.574s8.142-10.47 10.47-15.266"></path>
        <path
          fill="none"
          stroke="#fff"
        ...
        ></path>
        <path fill="none" stroke="#fff" d="M793.299 231.061L801.604 225.839"></path>
        <path fill="none" stroke="#fff" d="M810.319 249.812L818.625 245.911"></path>
        <path fill="none" stroke="#fff" d="M825.577 271.583L835.173 267.65"></path>
        <path fill="none" stroke="#fff" d="M837.816 296.5L847.82 293.008"></path>
        <path fill="none" stroke="#fff" d="M847.38 325.727L857.856 322.675"></path>
        <path fill="none" stroke="#fff" d="M853.074 355.363L863.96 354.073"></path>
      </g>
    </svg>
  );
}
